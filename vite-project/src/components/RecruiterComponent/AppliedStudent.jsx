          ...
          <Table className="w-full min-w-max shadow-lg rounded-lg overflow-hidden border border-gray-300 ">
            <TableHeader className="bg-gray-300">
              <TableRow>
                ...
                <TableHead className="text-center text-lg font-semibold p-2 whitespace-nowrap">Applicants</TableHead>
                <TableHead className="text-center text-lg font-semibold p-2 whitespace-nowrap">View Applicants</TableHead>
            ...
            <TableBody className="shadow-lg">
              {alluser?.map((job, idx) => (
                ...
                <TableRow key={job._id} className="odd:bg-gray-100 even:bg-white hover:bg-gray-200 transition">
                  ...
                  <TableCell className="text-center text-gray-700 p-2">{job?.UserApplied?.length || 0}</TableCell>
